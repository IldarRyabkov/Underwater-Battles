...
from colors import WHITE, BLUE, ORANGE, LIGHT_ORANGE, VIOLET, RED, PURPLE

###############################################################################
BOSS_HEAD_BODY = [[48, 2, BLUE,   0,   0,                   True,  0.03,  18, 0,   True,  False],
                  [35, 5, BLUE,   230, 0.055 * pi,          True,  0.054, 32, 0.6, True,  False],
                  [35, 5, BLUE,   230, -0.055 * pi,         True,  0.054, 32, 0.9, True,  False],
                  [22, 3, BLUE,   275, 0.045 * pi,          True,  0.035, 21, 0.7, True,  False],
                  [22, 3, BLUE,   275, -0.045 * pi,         True,  0.035, 21, 0.3, True,  False],
                  [39, 2, BLUE,   190, 0,                   True,  0.029, 17, 0.5, True,  False],
                  [82, 5, BLUE,   90,  0,                   True,  0.05,  30, 0.4, True,  False],
                  [22, 3, BLUE,   10,  0,                   True,  0.036, 22, 0.2, True,  False],
                  [22, 3, BLUE,   95,  0.31 * pi,           True,  0.036, 22, 0.6, True,  False],
                  [22, 3, BLUE,   95, -0.31 * pi,           True,  0.036, 22, 0.9, True,  False],
                  [36, 2, BLUE,   150, 0.22 * pi,           True,  0.025, 15, 0.1, True,  False],
                  [36, 2, BLUE,   150, -0.22 * pi,          True,  0.025, 15, 0.5, True,  False],
                  [26, 4, BLUE,   193, 0.225 * pi,          True,  0.04,  24, 0.2, True,  False],
                  [26, 4, BLUE,   193, -0.225 * pi,         True,  0.04,  24, 0.8, True,  False],
                  [15, 2, BLUE,   220, 0.21 * pi,           True,  0.022, 13, 0.7, True,  False],
                  [15, 2, BLUE,   220, -0.21 * pi,          True,  0.022, 13, 0.3, True,  False],

                  [10, 1, ORANGE, 80,  0,                   False, 0,     0,  0,   True,  True,  28, 0.26 * pi],
                  [10, 1, ORANGE, 80,  0,                   False, 0,     0,  0,   True,  True,  28, -0.26 * pi],
                  [10, 1, ORANGE, 80,  0,                   False, 0,     0,  0,   True,  True,  34, 0.16 * pi],
                  [10, 1, ORANGE, 80,  0,                   False, 0,     0,  0,   True,  True,  34, -0.16 * pi],
                  [10, 1, ORANGE, 80,  0,                   False, 0,     0,  0,   True,  True,  42, 0.065 * pi],
                  [10, 1, ORANGE, 80,  0,                   False, 0,     0,  0,   True,  True,  42, -0.065 * pi],
                  [15, 2, ORANGE, 80,  0,                   False, 0,     0,  0,   True,  True,  57, 0],
                  [30, 4, ORANGE, 80,  0,                   False, 0,     0,  0,   True,  True,  0,  0],

                  [10, 1, ORANGE, 210, 0.00,                True,  0.015, 9,  0.8, True,  True,  29, pi/4],
                  [10, 1, ORANGE, 210, 0.00,                True,  0.015, 9,  0.6, True,  True,  29, -pi/4],
                  [10, 1, ORANGE, 210, 0.00,                True,  0.015, 9,  0.4, True,  True,  42, pi/6],
                  [10, 1, ORANGE, 210, 0.00,                True,  0.015, 9,  0.2, True,  True,  42, -pi/6],
                  [9,  1, ORANGE, 210, 0.00,                True,  0.015, 9,  0,   True,  True,  55, pi/8],
                  [9,  1, ORANGE, 210, 0.00,                True,  0.015, 9,  0,   True,  True,  55, -pi/8],
                  [6,  1, ORANGE, 210, 0.00,                True,  0.01,  6,  0.3, True,  True,  56, -0.19*pi],
                  [6,  1, ORANGE, 210, 0.00,                True,  0.01,  6,  0.9, True,  True,  56, 0.19*pi],
                  [28, 4, ORANGE, 210, 0.00,                True,  0.044, 26, 0,   True,  True,  0,  0],
                  [12, 1, ORANGE, 210, 0.00,                True,  0.017, 10, 0.2, True,  True,  30, -pi],
                  [12, 1, ORANGE, 210, 0.00,                True,  0.017, 10, 0.5, True,  True,  30, -2 * pi/3],
                  [12, 1, ORANGE, 210, 0.00,                True,  0.017, 10, 0.8, True,  True,  30, 2 * pi/3],
...
###############################################################################
BOSS_LEG_BODY = [[41, 2, BLUE,   60,  0.25 * pi,           True,  0.029, 17, 0.3, True,  False],
                 [41, 2, BLUE,   60,  -0.25 * pi,          True,  0.029, 17, 0.7, True,  False],
                 [24, 3, BLUE,   100, 0.16 * pi,           True,  0.036, 22, 0.8, True,  False],
                 [24, 3, BLUE,   100, -0.16 * pi,          True,  0.036, 22, 0.4, True,  False],
                 [60, 3, BLUE,   20,  pi,                  True,  0.04,  24, 0.1, True,  False],
                 [24, 3, BLUE,   80,  0.66 * pi,           True,  0.036, 22, 0.3, True,  False],
                 [24, 3, BLUE,   80,  -0.66 * pi,          True,  0.036, 22, 0.7, True,  False],
                 [18, 3, BLUE,   110, 0.66 * pi,           True,  0.027, 16, 0.5, True,  False],
                 [18, 3, BLUE,   110, -0.66 * pi,          True,  0.027, 16, 0.9, True,  False],
                 [14, 2, BLUE,   134, 0.66 * pi,           True,  0.02,  12, 0.1, True,  False],
                 [14, 2, BLUE,   134, -0.66 * pi,          True,  0.02,  12, 0.4, True,  False],

                 [6,  1, ORANGE, 123, 0.13 * pi,           True,  0.009, 5,  0.1, True,  False],
                 [6,  1, ORANGE, 123, -0.13 * pi,          True,  0.009, 5,  0.4, True,  False],
                 [6,  1, ORANGE, 147, 0.135 * pi,          True,  0.009, 5,  0.7, True,  False],
                 [6,  1, ORANGE, 147, -0.135 * pi,         True,  0.009, 5,  0.2, True,  False],
                 [6,  1, ORANGE, 139, 0.085 * pi,          True,  0.009, 5,  0.5, True,  False],
                 [6,  1, ORANGE, 139, -0.085 * pi,         True,  0.009, 5,  0.8, True,  False],
                 [6,  1, ORANGE, 173, 0.135 * pi,          True,  0.009, 5,  0.3, True,  False],
                 [6,  1, ORANGE, 173, -0.135 * pi,         True,  0.009, 5,  0.6, True,  False],
                 [6,  1, ORANGE, 160, 0.054 * pi,          True,  0.009, 5,  0.0, True,  False],
                 [6,  1, ORANGE, 160, -0.054 * pi,         True,  0.009, 5,  0.5, True,  False],
                 [10, 1, ORANGE, 160, 0.14 * pi,           True,  0.017, 10, 0.1, True,  False],
                 [10, 1, ORANGE, 160, -0.14 * pi,          True,  0.017, 10, 0.4, True,  False],
                 [10, 1, ORANGE, 147, 0.063 * pi,          True,  0.017, 10, 0.6, True,  False],
                 [10, 1, ORANGE, 147, -0.063 * pi,         True,  0.017, 10, 0.9, True,  False],
                 [10, 1, ORANGE, 180, 0.117 * pi,          True,  0.017, 10, 0.3, True,  False],
                 [10, 1, ORANGE, 180, -0.117 * pi,         True,  0.017, 10, 0.7, True,  False],
                 [10, 1, ORANGE, 171, 0.062 * pi,          True,  0.017, 10, 0.2, True,  False],
                 [10, 1, ORANGE, 171, -0.062 * pi,         True,  0.017, 10, 0.5, True,  False],
                 [11, 1, ORANGE, 136, 0.115 * pi,          True,  0.017, 10, 0.1, True,  False],
                 [11, 1, ORANGE, 136, -0.115 * pi,         True,  0.017, 10, 0.4, True,  False],
...
###############################################################################
BOSS_HAND_BODY = [[90, 5, BLUE,   0,   0,                   True,  0.05,  30, 0,   True,  False],
                  [22, 3, BLUE,   100, 0.48 * pi,           True,  0.036, 22, 0.8, True,  False],
                  [22, 3, BLUE,   100, 0.96 * pi,           True,  0.036, 22, 0.4, True,  False],
                  [34, 4, BLUE,   105, -0.54 * pi,          True,  0.054, 32, 0.8, True,  False],
                  [34, 4, BLUE,   105, -0.03 * pi,          True,  0.054, 32, 0.4, True,  False],
                  [34, 4, BLUE,   105, -0.29 * pi,          True,  0.054, 32, 0.1, True,  False],
...
###############################################################################
BOSS_SKELETON_BODY = [[75, 3, PURPLE, 630, 0.936 * pi,          False, 0, 0, 0, True,  False],
                      [75, 3, PURPLE, 630, -0.936 * pi,         False, 0, 0, 0, True,  False],
                      [60, 3, PURPLE, 535, 0.946 * pi,          False, 0, 0, 0, True,  False],
                      [60, 3, PURPLE, 535, -0.946 * pi,         False, 0, 0, 0, True,  False],
                      [65, 3, PURPLE, 450, 0.964 * pi,          False, 0, 0, 0, True,  False],
                      [65, 3, PURPLE, 450, -0.964 * pi,         False, 0, 0, 0, True,  False],
                      [53, 2, PURPLE, 370, 0.968 * pi,          False, 0, 0, 0, True,  False],
                      [53, 2, PURPLE, 370, -0.968 * pi,         False, 0, 0, 0, True,  False],
                      [45, 2, PURPLE, 295, 0.968 * pi,          False, 0, 0, 0, True,  False],
                      [45, 2, PURPLE, 295, -0.968 * pi,         False, 0, 0, 0, True,  False],
                      [63, 3, PURPLE, 215, pi,                  False, 0, 0, 0, True,  False],
                      [54, 2, PURPLE, 135, pi,                  False, 0, 0, 0, True,  False],
                      [50, 2, PURPLE, 60,  pi,                  False, 0, 0, 0, True,  False],
                      [43, 2, PURPLE, 6,   0,                   False, 0, 0, 0, True,  False],
                      [45, 2, PURPLE, 70,  0,                   False, 0, 0, 0, True,  False],
                      [45, 2, PURPLE, 135, 0,                   False, 0, 0, 0, True,  False],
                      [50, 2, PURPLE, 200, 0,                   False, 0, 0, 0, True,  False],
                      [56, 3, PURPLE, 275, 0,                   False, 0, 0, 0, True,  False],
                      [62, 3, PURPLE, 355, 0,                   False, 0, 0, 0, True,  False],
                      [53, 2, PURPLE, 410, 0.028 * pi,          False, 0, 0, 0, True,  False],
                      [53, 2, PURPLE, 410, -0.028 * pi,         False, 0, 0, 0, True,  False],
                      [62, 3, PURPLE, 475, 0,                   False, 0, 0, 0, True,  False],
                      [45, 2, PURPLE, 490, 0.050 * pi,          False, 0, 0, 0, True,  False],
                      [45, 2, PURPLE, 490, -0.050 * pi,         False, 0, 0, 0, True,  False],
                      [81, 4, PURPLE, 555, 0,                   False, 0, 0, 0, True,  False],
                      [60, 3, PURPLE, 570, 0.052 * pi,          False, 0, 0, 0, True,  False],
                      [60, 3, PURPLE, 570, -0.052 * pi,         False, 0, 0, 0, True,  False],
                      [91, 5, PURPLE, 635, 0,                   False, 0, 0, 0, True,  False],
                      [72, 3, PURPLE, 655, 0.055 * pi,          False, 0, 0, 0, True,  False],
                      [72, 3, PURPLE, 655, -0.055 * pi,         False, 0, 0, 0, True,  False],

                      [38, 2, BLUE,   765, 0.041 * pi,          False, 0, 0, 0, True,  False],
                      [38, 2, BLUE,   765, -0.041 * pi,         False, 0, 0, 0, True,  False],
                      [38, 2, BLUE,   710, 0.040 * pi,          False, 0, 0, 0, True,  False],
                      [38, 2, BLUE,   710, -0.040 * pi,         False, 0, 0, 0, True,  False],
                      [31, 2, BLUE,   750, 0.129 * pi,          False, 0, 0, 0, True,  False],
                      [31, 2, BLUE,   750, -0.129 * pi,         False, 0, 0, 0, True,  False],
                      [27, 2, BLUE,   705, 0.129 * pi,          False, 0, 0, 0, True,  False],
                      [27, 2, BLUE,   705, -0.129 * pi,         False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   745, 0.187 * pi,          False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   745, -0.187 * pi,         False, 0, 0, 0, True,  False],
                      [21, 2, BLUE,   712, 0.185 * pi,          False, 0, 0, 0, True,  False],
                      [21, 2, BLUE,   712, -0.185 * pi,         False, 0, 0, 0, True,  False],
                      [25, 2, BLUE,   745, 0.231 * pi,          False, 0, 0, 0, True,  False],
                      [25, 2, BLUE,   745, -0.231 * pi,         False, 0, 0, 0, True,  False],
                      [23, 2, BLUE,   715, 0.231 * pi,          False, 0, 0, 0, True,  False],
                      [23, 2, BLUE,   715, -0.231 * pi,         False, 0, 0, 0, True,  False],
                      [34, 1, BLUE,   680, 0.270 * pi,          False, 0, 0, 0, True,  False],
                      [34, 1, BLUE,   680, -0.270 * pi,         False, 0, 0, 0, True,  False],
                      [44, 1, BLUE,   645, 0.262 * pi,          False, 0, 0, 0, True,  False],
                      [44, 1, BLUE,   645, -0.262 * pi,         False, 0, 0, 0, True,  False],
                      [95, 2, BLUE,   735, 0.080 * pi,          False, 0, 0, 0, True,  False],
                      [95, 2, BLUE,   735, -0.080 * pi,         False, 0, 0, 0, True,  False],
                      [61, 2, BLUE,   730, 0.155 * pi,          False, 0, 0, 0, True,  False],
                      [61, 2, BLUE,   730, -0.155 * pi,         False, 0, 0, 0, True,  False],
                      [49, 2, BLUE,   730, 0.208 * pi,          False, 0, 0, 0, True,  False],
                      [49, 2, BLUE,   730, -0.208 * pi,         False, 0, 0, 0, True,  False],
                      [34, 1, BLUE,   732, 0.247 * pi,          False, 0, 0, 0, True,  False],
                      [34, 1, BLUE,   732, -0.247 * pi,         False, 0, 0, 0, True,  False],
                      [73, 2, BLUE,   750, 0.275 * pi,          False, 0, 0, 0, True,  False],
                      [73, 2, BLUE,   750, -0.275 * pi,         False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   815, 0.260 * pi,          False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   815, -0.260 * pi,         False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   815, 0.291 * pi,          False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   815, -0.291 * pi,         False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   752, 0.306 * pi,          False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   752, -0.306 * pi,         False, 0, 0, 0, True,  False],

                      [12, 2, BLUE,   824, 0.061 * pi,          False, 0, 0, 0, True,  False],
                      [12, 2, BLUE,   824, -0.061 * pi,         False, 0, 0, 0, True,  False],
                      [20, 2, BLUE,   831, 0.069 * pi,          False, 0, 0, 0, True,  False],
                      [20, 2, BLUE,   831, -0.069 * pi,         False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   835, 0.082 * pi,          False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   835, -0.082 * pi,         False, 0, 0, 0, True,  False],
                      [20, 2, BLUE,   868, 0.086 * pi,          False, 0, 0, 0, True,  False],
                      [20, 2, BLUE,   868, -0.086 * pi,         False, 0, 0, 0, True,  False],
                      [12, 1, RED,    891, 0.089 * pi,          False, 0, 0, 0, True,  False],
                      [12, 1, RED,    891, -0.089 * pi,         False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   860, 0.112 * pi,          False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   860, -0.112 * pi,         False, 0, 0, 0, True,  False],
                      [20, 2, BLUE,   887, 0.120 * pi,          False, 0, 0, 0, True,  False],
                      [20, 2, BLUE,   887, -0.120 * pi,         False, 0, 0, 0, True,  False],
                      [12, 1, RED,    905, 0.125 * pi,          False, 0, 0, 0, True,  False],
                      [12, 1, RED,    905, -0.125 * pi,         False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   800, 0.087 * pi,          False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   800, -0.087 * pi,         False, 0, 0, 0, True,  False],
                      [36, 2, BLUE,   825, 0.100 * pi,          False, 0, 0, 0, True,  False],
                      [36, 2, BLUE,   825, -0.100 * pi,         False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   785, 0.171 * pi,          False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   785, -0.171 * pi,         False, 0, 0, 0, True,  False],
                      [18, 2, BLUE,   805, 0.179 * pi,          False, 0, 0, 0, True,  False],
                      [18, 2, BLUE,   805, -0.179 * pi,         False, 0, 0, 0, True,  False],
                      [21, 2, BLUE,   770, 0.223 * pi,          False, 0, 0, 0, True,  False],
                      [21, 2, BLUE,   770, -0.223 * pi,         False, 0, 0, 0, True,  False],
                      [14, 2, BLUE,   788, 0.231 * pi,          False, 0, 0, 0, True,  False],
                      [14, 2, BLUE,   788, -0.231 * pi,         False, 0, 0, 0, True,  False],

                      [12, 2, BLUE,   722, 0.086 * pi,          False, 0, 0, 0, True,  False],
                      [12, 2, BLUE,   722, -0.086 * pi,         False, 0, 0, 0, True,  False],
                      [12, 2, BLUE,   722, 0.073 * pi,          False, 0, 0, 0, True,  False],
                      [12, 2, BLUE,   722, -0.073 * pi,         False, 0, 0, 0, True,  False],
                      [20, 2, BLUE,   705, 0.065 * pi,          False, 0, 0, 0, True,  False],
                      [20, 2, BLUE,   705, -0.065 * pi,         False, 0, 0, 0, True,  False],
                      [20, 2, BLUE,   703, 0.094 * pi,          False, 0, 0, 0, True,  False],
                      [20, 2, BLUE,   703, -0.094 * pi,         False, 0, 0, 0, True,  False],
                      [31, 1, BLUE,   675, 0.108 * pi,          False, 0, 0, 0, True,  False],
                      [31, 1, BLUE,   675, -0.108 * pi,         False, 0, 0, 0, True,  False],
                      [31, 1, BLUE,   680, 0.051 * pi,          False, 0, 0, 0, True,  False],
                      [31, 1, BLUE,   680, -0.051 * pi,         False, 0, 0, 0, True,  False],

                      [35, 1, BLUE,   672, 0.015 * pi,          False, 0, 0, 0, True,  False],
                      [35, 1, BLUE,   672, -0.015 * pi,         False, 0, 0, 0, True,  False],
                      [85, 2, BLUE,   755, 0,                   False, 0, 0, 0, True,  False],

                      [29, 1, BLUE,   855, 0.041 * pi,          False, 0, 0, 0, True,  False],
                      [29, 1, BLUE,   855, -0.041 * pi,         False, 0, 0, 0, True,  False],
                      [29, 1, BLUE,   895, 0,                   False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   890, 0.048 * pi,          False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   890, -0.048 * pi,         False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   935, 0,                   False, 0, 0, 0, True,  False],
                      [20, 2, BLUE,   920, 0.0538 * pi,         False, 0, 0, 0, True,  False],
                      [20, 2, BLUE,   920, -0.0538 * pi,        False, 0, 0, 0, True,  False],
                      [20, 2, BLUE,   970, 0,                   False, 0, 0, 0, True,  False],
                      [17, 2, BLUE,   943, 0.0575 * pi,         False, 0, 0, 0, True,  False],
                      [17, 2, BLUE,   943, -0.0575 * pi,        False, 0, 0, 0, True,  False],
                      [17, 2, BLUE,   998, 0,                   False, 0, 0, 0, True,  False],
                      [12, 1, RED,    961, 0.0605 * pi,         False, 0, 0, 0, True,  False],
                      [12, 1, RED,    961, -0.0605 * pi,        False, 0, 0, 0, True,  False],
                      [12, 1, RED,    1017, 0,                  False, 0, 0, 0, True,  False],
                      [36, 1, BLUE,   815, 0.032 * pi,          False, 0, 0, 0, True,  False],
                      [36, 1, BLUE,   815, -0.032 * pi,         False, 0, 0, 0, True,  False],
                      [36, 1, BLUE,   850, 0,                   False, 0, 0, 0, True,  False],

                      [20, 2, BLUE,   680, 0,                   False, 0, 0, 0, True,  False],
                      [20, 2, BLUE,   755, 0,                   False, 0, 0, 0, True,  False],
                      [27, 2, BLUE,   717, 0,                   False, 0, 0, 0, True,  False],
                      [12, 2, BLUE,   731, 0.012 * pi,          False, 0, 0, 0, True,  False],
                      [12, 2, BLUE,   731, -0.012 * pi,         False, 0, 0, 0, True,  False],
                      [12, 2, BLUE,   780, 0,                   False, 0, 0, 0, True,  False],
                      [8,  1, RED,    707, 0.010 * pi,          False, 0, 0, 0, True,  False],
                      [8,  1, RED,    707, -0.010 * pi,         False, 0, 0, 0, True,  False],
                      [8,  1, RED,    691, 0,                   False, 0, 0, 0, True,  False],

                      [42, 2, BLUE,   770, 0.965 * pi,          False, 0, 0, 0, True,  False],
                      [42, 2, BLUE,   770, -0.965 * pi,         False, 0, 0, 0, True,  False],
                      [60, 2, BLUE,   610, pi,                  False, 0, 0, 0, True,  False],
                      [42, 2, BLUE,   770, 0.965 * pi,          False, 0, 0, 0, True,  False],
                      [42, 2, BLUE,   770, -0.965 * pi,         False, 0, 0, 0, True,  False],
                      [85, 2, BLUE,   710, 0.94 * pi,           False, 0, 0, 0, True,  False],
                      [85, 2, BLUE,   710, -0.94 * pi,          False, 0, 0, 0, True,  False],
                      [70, 2, BLUE,   700, pi,                  False, 0, 0, 0, True,  False],
                      [37, 2, BLUE,   770, 0.91 * pi,           False, 0, 0, 0, True,  False],
                      [37, 2, BLUE,   770, -0.91 * pi,          False, 0, 0, 0, True,  False],
                      [25, 2, BLUE,   795, 0.895 * pi,          False, 0, 0, 0, True,  False],
                      [25, 2, BLUE,   795, -0.895 * pi,         False, 0, 0, 0, True,  False],
                      [30, 1, BLUE,   766, pi,                  False, 0, 0, 0, True,  False],
                      [26, 2, BLUE,   812, pi,                  False, 0, 0, 0, True,  False],
